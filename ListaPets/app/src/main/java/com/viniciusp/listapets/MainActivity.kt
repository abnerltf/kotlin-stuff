...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lista = mutableListOf<Pet>(
            Pet(nome="Alex", raca="Pastor Alemão", foto=resources.getDrawable(R.drawable.german)),
            Pet(nome="Iron", raca="Labrador", foto=resources.getDrawable(R.drawable.labrador))
        )
